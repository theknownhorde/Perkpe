...
const TransferPoints = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Generate transaction data for blockchain validation
            ...
            // Navigate to blockchain validation page with transaction data
            navigate('/blockchain-validation', {
        ...
        <Container className="py-4">
            <Card className="shadow-sm">
                <Card.Header className="bg-primary text-white">
                    <Card.Title className="h4 mb-0">Transfer Points</Card.Title>
                </Card.Header>
                <Card.Body>
                    {error && <Alert variant="danger">{error}</Alert>}
